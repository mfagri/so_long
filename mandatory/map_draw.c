...
/*   Updated: 2022/03/21 13:32:38 by mfagri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mouve_player_2(t_data *m)
{
	...
	if (i % 10 == 0)
	{
		...
		{
			j = 0;
			m->img_p_1 = mlx_xpm_file_to_image(m->mlx_ptr, "./img/v1.xpm", \
			&m->a, &m->b);
		}
		else
		{
			j = 1;
			m->img_p_1 = mlx_xpm_file_to_image(m->mlx_ptr, "./img/v2.xpm", \
			&m->a, &m->b);
		}
	}
	if (i == 100000)
